...
// fastrand is a lightweight random number generator.
// We use a simple module-level approach since it's thread-local.
mod fastrand {
    use std::cell::Cell;
